  ...
  <div class="container flex flex-wrap justify-between items-center mx-auto">
    ...
    <div class="px-4 mx-auto text-center max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="flex justify-center mt-8 space-x-3">
            ...
            <a href="#" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-indigo-700 bg-indigo-100 border border-transparent rounded-md hover:bg-indigo-200" data-primary="indigo-600" data-rounded="rounded-md">Bell</a>
        </div>
    </div>
