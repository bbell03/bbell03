    ...
    <section className="mb-6 pb-20" contenteditable="true">
        <div className="px-4 sm:px-7 mx-auto max-w-7xl lg:px-8">
            ...
            <div className="grid grid-cols-1 gap-0 text-gray-600 md:grid-cols-2 md:gap-16">
              <div>
                <h4 className="mt-10 mb-3 font-semibold text-gray-900 sm:text-2xl">Who am I?</h4>
                ...
                <h2 className="mt-10 mb-3 font-semibold text-gray-900 sm:text-2xl">What have I done?</h2>
                <p className = "text-lg sm:text-xl">
            ...
            <div className="">
                <h4 className="mt-10 mb-3 font-semibold text-gray-900 sm:text-2xl">What am I looking for?</h4>
                <p  className = "text-lg sm:text-xl">
                ...
                <h4 className="mt-10 mb-3 font-semibold text-gray-900 sm:text-2xl">What is the meaning of this?</h4>
                <p  className = "text-lg sm:text-xl">
