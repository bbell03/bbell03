...
const HomePagePhoto = () => {
  return (
    <div class="sm:mt-2 xs:mt-2 grid grid-col-1 justify-center mx-6 object-fit">
      <img class="lg:max-w-md md:max-w-md max-w-sm object-center rounded-full shadow-xl" src="/img/store.jpg" alt="Man looking at item at a store"></img>
