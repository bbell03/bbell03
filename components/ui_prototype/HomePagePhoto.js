...
const HomePagePhoto = () => {
  return (
    <div class="hidden sm:block sm:mt-2 xs:mt-2 grid grid-col-1 justify-center object-fit">
      ...
      <div className="flex object-center justify-center mt-8 mb-4 space-x-3">
      </div>
    </div>
  )
}
