...
const HomePagePhoto = () => {
  return (
    <div class="hidden sm:block sm:mt-2 xs:mt-2 grid grid-col-1 object-fit">
      <img class="object-scale-down h-56 w-56 mt-6 md:max-w-sm max-w-sm rounded-full shadow-xl" src="/img/bb.jpg" alt="Man looking at item at a store"></img>
      <div className="flex justify-center mt-8 mb-0 space-x-3">
      </div>
    </div>
  )
}
