...
const BlogPost = () => {
  return (
    <div class="flex items-center">
      <a href = "https://pg-grouping.vercel.app"class="group relative mx-auto w-96 overflow-hidden rounded-[16px] bg-gray-300 p-[1px] transition-all duration-300 ease-in-out hover:bg-gradient-to-r hover:from-indigo-500 hover:via-purple-500 hover:to-pink-500">
